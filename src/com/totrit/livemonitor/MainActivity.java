...
public class MainActivity extends Activity {
	...
	private void setupHiderFeature() {
		...
		mSystemUiHider = SystemUiHider.getInstance(this, mSurfaceView,
				HIDER_FLAGS);
	...
	private class ServiceMessenger {
	    ...
	    private ServiceConnection mServiceConnection = new ServiceConnection() {
	        ...
	        public void onServiceConnected(ComponentName name, IBinder service) {
	    		...
	    		//TODO test
	    		mMessenger.sendMessage(Message.obtain(null, ProcessService.MSG_START_OBSERVE_PREVIEW, Camera.CameraInfo.CAMERA_FACING_BACK, 50));
	        }
		...
		private boolean doBindService() {
		    return bindService(new Intent(MainActivity.this, 
		            ProcessService.class), mServiceConnection, Context.BIND_AUTO_CREATE);
		}
